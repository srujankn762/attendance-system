...
SECRET_KEY = 'django-insecure-0^(xhodj=gwj)aldjc5d-3p22f5g0pbn(v8s(+)=$rgr1bi1w5'
...
MIDDLEWARE = [
    'attendance_project.middleware.log_http.LogRequestResponseMiddleware',
...
LOGGING = {
    ...
    "formatters": {
        "verbose": {
            "format": "[%(asctime)s] [%(levelname)s] [PID:%(process)d TID:%(thread)d %(threadName)s] %(message)s"
        },
    },
    "handlers": {
        "console": {
